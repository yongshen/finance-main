 ...
 *
 * **Source Object (or element):** A js object containing information
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    if (options['iFrameMode'] === true && !vjs.IS_FIREFOX) {
      ...
      // Tried embedding the flash object through js in the iframe source.
      // This works in webkit but still triggers the firefox security error
      // iFrm.src = 'js: document.write('"+vjs.Flash.getEmbedCode(options['swf'], flashVars, params, attributes)+"');";
...
vjs.Flash.prototype.supportsFullScreen = function(){
  return false; // Flash does not allow fullscreen through js
};
